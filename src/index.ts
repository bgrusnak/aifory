...
export class Aifory {
  ...
  ): Promise<AiforyResponse<P2PPayinResponse>> {
  ...
  ): Promise<AiforyResponse<WithdrawResponse>> {
  ...
  ): Promise<AiforyResponse<{ success: boolean }>> {
  ...
  async createReport(
    data: ReportRequest,
  ): Promise<AiforyResponse<{ uid: string }>> {
